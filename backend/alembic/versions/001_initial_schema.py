...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "external_id", sa.String(500), nullable=True,
        ),
        sa.Column(
            "title", sa.String(1000), nullable=True,
        ),
        sa.Column(
            "doc_type", sa.String(50), nullable=False,
        ),
    ...
    op.create_index(
        "idx_documents_metadata", "documents",
    ...
    op.create_table(
        ...
        sa.Column("content", sa.Text, nullable=False),
        sa.Column(
            "token_count", sa.Integer, nullable=False,
        ),
        sa.Column(
